...
import { RegexReplaceMultiParams, ReplaceResult, FileProcessingResult } from '../types.js';
 ...
 */
export async function regexReplaceMulti(params: RegexReplaceMultiParams): Promise<ReplaceResult[]> {
  try {
    const {
      path_pattern,
      pattern,
