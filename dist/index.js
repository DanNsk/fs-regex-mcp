...
class RegexMCPServer {
    ...
    async handleRegexSearchMulti(args) {
        const results = await regexSearchMulti(args);
        return {
            content: [
                {
                    type: 'text',
    ...
    async handleRegexReplaceMulti(args) {
        const results = await regexReplaceMulti(args);
        return {
            content: [
                {
                    type: 'text',
