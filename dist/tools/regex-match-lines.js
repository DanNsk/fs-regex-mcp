...
export async function regexMatchLines(params) {
    const operation = async () => {
        const { path_pattern, pattern, flags, literal = false, invert = false, max_lines, exclude = [], binary_check_buffer_size = DEFAULT_BINARY_CHECK_SIZE, max_results = DEFAULT_MAX_RESULTS, } = params;
