...
import { parsePattern, createRegex, readFileWithBinaryCheck, getContext, findAllMatches, getLineAndColumn, DEFAULT_BINARY_CHECK_SIZE, } from '../utils.js';
/**
...
export async function regexSearch(params) {
    try {
        const { path_pattern, pattern, flags, context_before = 0, context_after = 0, max_matches, exclude = [], binary_check_buffer_size = DEFAULT_BINARY_CHECK_SIZE, } = params;
