...
export async function regexReplace(params) {
    try {
        const { file_path, pattern, replacement, flags, context_before = 0, context_after = 0, dry_run = false, max_replacements, binary_check_buffer_size = DEFAULT_BINARY_CHECK_SIZE, } = params;
